...
class DListNode<E> implements Serializable {
	 ...
	 * 
	 * @param theElement
	 *            - The element to be contained in the node
	 * @param thePrevious
	 *            - the previous node
	 * @param theNext
	 *            - the next node
	 ...
	 * 
	 * @param newElement
	 *            - New element to replace the current element
	 */
	 ...
	 * 
	 * @param newPrevious
	 *            - node to replace the current previous node
	 */
